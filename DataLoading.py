...
options = {
    ...
    10: ("مجموعة اسكتشات",2,"ميس ماريا"),
    11: ("مجموعة حفلة سمر",2,"ميس رشا"),
    12: ("ترتيب القداس والحمل",1,"ميس عبير"),
    13: ("مجموعة خلوات",2,"ميس ايرين + ميس عبير"),
    14: (" مجموعة ورش Workshops",2,"مستر مايكل+ ميس ايرين +مس رشا "),
    15: ("مجموعة ترتيب المتكلمين اللي من خارج الكنيسة"  ,2,"مستر مينا"),
    16: ("مجموعة درس كتاب",2,"ميس عبير + مستر بيتر+ ميس نشوى"),  
}
